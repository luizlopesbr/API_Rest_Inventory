...
A API permite cadastrar algumas informações de hardware e sotware de uma estação de trabação, muito útil na Governança de TI para fazer controle de inventário.
...
O fluxo de responsabilidades no projeto segue uma arquitetura em camadas e bem organizada. 
